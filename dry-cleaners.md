...
Garment tags, conveyor slots and per-piece tickets — with wash & fold and pickup & delivery on the same counter when you offer them.
...
## What a dry cleaner gets on day one

Choose "Dry cleaner" at sign-up and this is the POS you see — the tools below and nothing that gets in the way. Change it any time in Settings.
...
**Every order has a column. Every column has a count.** Orders move left to right through inspection & tagging, cleaning, pressing and completed, so nothing sits forgotten on a rail.
