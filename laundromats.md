...
Wash & fold by the pound at the counter, a live map of every washer and dryer on the floor, and every order followed from drop-off to pickup.
...
## What a laundromat gets on day one

Choose "Laundromat" at sign-up and this is the POS you see — the tools below and nothing that gets in the way. Change it any time in Settings.
...
**Every order has a column. Every column has a count.** Orders move left to right through washing, drying, folding and completed, so nothing sits forgotten in a machine.
